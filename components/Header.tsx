...
export default function Header() {
  ...
  hover:fill-white"
                                data-bs-toggle="modal"
                                data-bs-target="#delegateEnquiry"
                                data-modal-title="Delegate Enquiry"
                                data-form-id="3f12b354-2e4f-4a4e-ae09-09d0d6e96926"
                            >
                                Delegate Enquiry
                            </Link>
                        </div>
            ...
            <div className="block md:!hidden text-center">
                <div className="flex items-center justify-center gap-5 mt-10">
                    <Link href="#" id="wfis-ke-sponsor" className="inline-block text-[12px] font-semibold uppercase not-italic no-underline tracking-[2px] text-black fill-black bg-[var(--tp-bg-3)] rounded-none py-[15px] px-[10px] border border-0 transition-all duration-300 hover:bg-[var(--tp-bg-2)] 
  hover:text-white 
  hover:fill-white"
                        data-bs-toggle="modal"
                        data-bs-target="#sponsorEnquiry"
